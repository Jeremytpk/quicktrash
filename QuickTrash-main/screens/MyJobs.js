...
const MyJobs = () => {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              // Find the job to complete
              const jobToComplete = jobs.find(job => job.id === jobId);
              ...
              Alert.alert('Success', 'Job completed! Please rate your experience.');
            } catch (error) {
  ...
  const handleRatingComplete = () => {
    ...
    setJobToRate(null);
    // Navigate to rating dashboard to see updated score
    // navigation.navigate('RatingDashboard');
  };
