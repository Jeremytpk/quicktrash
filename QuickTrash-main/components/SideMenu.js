        ...
        return [
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'My Rating', icon: 'star-outline', screen: 'RatingDashboard' },
        ...
        return [
          {
            ...
            items: [
              ...
              { title: 'Command Center', icon: 'desktop-outline', screen: 'OperationsCommandCenter' },
          ...
          },
          {
            ...
            items: [
              ...
              { title: 'Rating Management', icon: 'star-outline', screen: 'UserRatingManagement' },
              { title: 'Contractor Onboarding', icon: 'person-add-outline', screen: 'ContractorOnboarding' },
            ]
          },
          {
            title: 'Partnerships',
            items: [
              { title: 'Partner Management', icon: 'business-outline', screen: 'PartnerManagement' },
              { title: 'Disposal Facilities', icon: 'trash-outline', screen: 'DisposalFacilities' },
            ]
          },
          {
            title: 'Support & Tools',
